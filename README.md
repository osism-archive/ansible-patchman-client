# Ansible osism.patchman-client

[![Build Status](https://travis-ci.org/osism/ansible-patchman-client.svg?branch=master)](https://travis-ci.org/osism/ansible-patchman-client)
